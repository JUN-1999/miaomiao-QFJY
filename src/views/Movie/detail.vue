	...
	<div id="detailContrainer" class="slide-enter-active">
		...
		<div v-else id="content" class="contentDetail">
			...
			<div class="detail_list">
				...
				<div class="detail_list_content">
					<div class="detail_list_img">
						<img :src="detailMovie.img | MovieImg" alt="" />
					</div>
					<div class="detail_list_info">
			...
			<div ref="detail_player" class="detail_player swiper-container">
				<ul class="swiper-wrapper">
					<li
...
<script>
// /ajax/detailmovie?movieId=1217023&optimus_uuid=B878F850608311EB84319F63E554F05021E28AB68CA646F1B9B4DC8CAE798EDA&optimus_risk_level=71&optimus_code=10
...
export default {
	...
	mounted() {
		...
		axios({
			url: `/ajax/detailmovie?movieId=${this.movieId}&optimus_uuid=B878F850608311EB84319F63E554F05021E28AB68CA646F1B9B4DC8CAE798EDA&optimus_risk_level=71&optimus_code=10`
		}).then(res => {
